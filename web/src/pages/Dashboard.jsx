...
function Donut({ value = 0 }) {
  ...
  return (
    <svg viewBox="0 0 100 100" className="w-32 h-32">
      <circle cx="50" cy="50" r={r} strokeWidth="12" fill="none" className="stroke-gray-200" />
      <circle cx="50" cy="50" r={r} strokeWidth="12" fill="none"
        className="stroke-green-500 -rotate-90 origin-center"
        strokeDasharray={c} strokeDashoffset={off}/>
      <text x="50" y="54" textAnchor="middle" className="fill-gray-800 text-xl font-bold">{value}%</text>
    </svg>
  );
}
